...
public class AndroidAppStepDefinations {
	...
	public void android_user_installed_the_new_CD_app_and_launched_successfully(String Platform, String app) throws Throwable {
		...
		Platform = Constants.CONFIG.getProperty("platformNameAndroid");
...
//			LogCapture.info("Menta Application installed and launched successfully......!!!!");
		...
		else if(Constants.CONFIG.getProperty("isBrowserstackJenkins").equals("true"))
		{
			...
			Assert.assertEquals(Constants.KEYWORD_PASS,Constants.key.launchANDROIDAppOnBrowserStack(Platform , app, rep, vVersion));
